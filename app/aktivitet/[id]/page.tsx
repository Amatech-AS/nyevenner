...
import { ArrowLeft, Calendar, MapPin, CheckCircle, XCircle, Users, Loader2, Info, Edit2, Trash2, Navigation, Coins } from 'lucide-react';
...
// --- SMART BILDEVELGER (Full versjon for konsistens) ---
...
export default function AktivitetDetalj() {
  ...
  // Henter bilde (Enten fra DB eller smart-generator)
              ...
              <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '24px', border: '1px solid #e2e8f0', textAlign: 'center' }}>
                ...
                <button
                  ...
                  style={{ 
                      ...
                      // Løst: Separert border logikken til en egen property eller style override
                  }}
                >
