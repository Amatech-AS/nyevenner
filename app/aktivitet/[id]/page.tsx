...
import Weather from '@/components/Weather'; // <-- NY
import { ArrowLeft, Calendar, MapPin, CheckCircle, XCircle, Users, Loader2, Info, Edit2, Trash2 } from 'lucide-react';
...
type AktivitetType = { id: string; tittel: string; beskrivelse: string; dato: string; sted: string; max_deltakere: number | null; image_url: string | null; price: number; creator_id: string; postnummer: string; }

// ... (Behold getSmartImage/imageCollections her også for fallback-bilde i sidebar) ...
