...
import { ArrowLeft, Calendar, MapPin, CheckCircle, XCircle, Users, Loader2, Info, Coins, Edit2, Trash2, Navigation, CloudSun } from 'lucide-react';
...
// --- SMART BILDEVELGER (Full versjon med typer) ---
            ...
            <div style={{ flex: '1', minWidth: '300px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '24px', border: '1px solid #e2e8f0' }}>
                 <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                    ...
                    <p style={{ fontSize: '12px', fontWeight: 'bold', textTransform: 'uppercase', color: '#94a3b8' }}>Værmelding</p>
                 </div>
                 <p style={{ fontSize: '13px', color: '#64748b', marginBottom: '16px', lineHeight: '1.4' }}>
                    Gjelder for {aktivitet.sted} den {aktivitet.dato ? aktivitet.dato.split('kl')[0] : 'datoen'}.
                 </p>
              ...
              <div style={{ backgroundColor: 'white', padding: '24px', borderRadius: '24px', border: '1px solid #e2e8f0', textAlign: 'center' }}>
                ...
                <button
                  ...
                  style={{ 
                      ...
                      outline: erPaameldt ? '2px solid #fee2e2' : 'none'
                  }}
                >
